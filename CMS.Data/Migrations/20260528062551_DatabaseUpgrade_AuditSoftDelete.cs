...
{
    /// <inheritdoc />
    public partial class DatabaseUpgrade_AuditSoftDelete : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                INSERT INTO [CustomerAddresses]
                    ([CustomerId], [ReceiverName], [ReceiverPhone], [AddressLine], [Province], [District], [Ward], [AddressType], [IsDefault], [CreatedAt], [UpdatedAt], [IsDeleted], [DeletedAt])
                SELECT
                    [Id],
                    COALESCE(NULLIF([FullName], ''), N'Khách hàng'),
                    COALESCE([Phone], ''),
                    [Address],
                    '',
                    '',
                    ...
                    NULL
                FROM [Customers]
                WHERE [Address] IS NOT NULL AND LTRIM(RTRIM([Address])) <> '';
            ");
            ...
            migrationBuilder.Sql(@"
                SET IDENTITY_INSERT [PostCategories] ON;

                INSERT INTO [PostCategories] ([Id], [Name], [Description], [CreatedAt], [UpdatedAt], [IsDeleted], [DeletedAt])
                SELECT [Id], [Name], NULLIF([Description], ''), SYSUTCDATETIME(), NULL, CAST(0 AS bit), NULL
                FROM [Categories];

                SET IDENTITY_INSERT [PostCategories] OFF;
            ");
            ...
            migrationBuilder.Sql(@"
                ...
                INSERT INTO [ProductCategories] ([Id], [Name], [Description], [CreatedAt], [UpdatedAt], [IsDeleted], [DeletedAt])
                SELECT [Id], [Name], [Description], SYSUTCDATETIME(), NULL, CAST(0 AS bit), NULL
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PriceSurcharge = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetailOptions", x => new { x.OrderDetailId, x.OptionValueId });
                    table.ForeignKey(
                        name: "FK_OrderDetailOptions_OptionValues_OptionValueId",
